    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.buttonContainer}>
          <button aria-label="Previous Image" onClick={prevButton} className={styles.buttonPrev}>
            Prev
          </button>
          <button aria-label="Next Image" onClick={nextButton} className={styles.buttonNext}>
            Next
          </button>
        </div>
      </div>
